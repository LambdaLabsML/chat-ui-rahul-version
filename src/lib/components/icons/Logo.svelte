...
{:else if envPublic.PUBLIC_APP_ASSETS === "lambda"}
	<svg
		height='100%'
		width="30"
		viewBox="0 0 500 493.56"
		xmlns="http://www.w3.org/2000/svg"
		class={classNames}
		fill="currentColor"
	>
		<polygon class="cls-1" points="132.06 82.08 219.04 234.55 122.26 411.1 184.57 411.04 249.07 290.59 317.75 411.1 381.25 411.1 195.53 82.05 132.06 82.08"/>
		<path class="cls-1" d="M0,0V493.56H500V0H0ZM455.84,450.1H44.17V43.46H455.84V450.1Z"/>
	</svg>
{:else}
	<img
		class={classNames}
